# Nexlayer — deep-iris-medusa

**Live:** [https://relaxed-weasel-deep-iris-medusa.cloud.nexlayer.ai](https://relaxed-weasel-deep-iris-medusa.cloud.nexlayer.ai)  
...
**deep-iris-medusa** is deployed on [Nexlayer](https://nexlayer.ai) — a container-native
...
```yaml
application:
  name: deep-iris-medusa
  pods:
    - name: app
      image: "registry.nexlayer.io/user_01kece1xyh817dwff7wnarhkxd/medusa:19f214653e7"
      path: /
      servicePorts:
        - 80
      vars:
